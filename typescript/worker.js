...
const GameOverTauntMessages = [
  "I’ll be back—for the high score!",
  "Hasta la vista, baby… retry!",
  "May the respawn be with you!",
  "I am your dad… uh, respawn!",
  "You shall not stay defeated!",
  "This is the way… play on!",
  "Just keep swimming… respawn!",
  "Wax on… respawn on!",
  "Gotta catch ’em… respawns!",
  "Gawrsh! Goofy says retry!",
  "What’s up, doc? Try again!",
  "That’s all, folks… do it again!",
  "Ruh-roh… Scooby’d retry!",
  "ShinChan chaos—play again!",
  "Gadget ready? Doraemon’s back!",
  "Pikachu down? Zap on!",
  "Hattori speed—dash again!",
  "Laddoo power—jump back!",
  "It’s morphin’ time… again!",
  "Girls, power up & retry!",
  "I’m Popeye—respawn strong!",
  "I volunteer… for round two!",
  "Bond. James Bond… and retry?",
  "Bond. James Bond… respawn!",
  "Frankly, my dear… I retry!",
  "Here’s Johnny… play on!",
  "Say hello to my little… retry!",
  "I love smell of victory… tomorrow!",
  "Go ahead, make my respawn!",
  "I feel the need… for respawn!",
  "It’s alive! Respawn!",
  "One does not simply retry!",
  "Why so serious? Smile & go!",
  "Keep punching… respawn!",
  "Nobody puts… you back!",
  "I drink and I know things—retry.",
  "Winter is coming… prepare!",
  "Valar Respawn-his!",
  "This is Sparta… play on!",
  "Of all games… you gotta retry!",
  "Here’s looking at you… retry!",
  "You talkin’ to me? Me too!",
  "Run, Forrest… respawn!",
  "Show me the respawns!",
  "You can’t handle respawns!",
  "Houston, we have restart.",
  "I’m the king… of respawns!",
  "I’ll get that high score… again!",
  "You can’t stop… my retry!",
  "Keep calm… just respawn!",
