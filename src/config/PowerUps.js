...
export const POWERS = {
  ...
  Echo:          { pill: 'ECHO',    short: 'EC', category: 'ball', color: 0xe0e0e0, dur: 8000,  kind: 'timed', weight: 5, polarity: 'pos', icon: 'radar',     ballMod: 'echo',      desc: 'Orbiting echoes chip nearby bricks — steady, not instant clear' },
